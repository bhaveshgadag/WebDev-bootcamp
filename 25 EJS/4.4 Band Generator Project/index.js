...
app.post("/submit", (req, res) => {
  ...
  let adj_ran = Math.floor(Math.random() * adj.length);
  let noun_ran = Math.floor(Math.random() * noun.length);
  res.locals.adjective = adj[adj_ran];
  res.locals.noun1 = noun[noun_ran];
  res.render("index.ejs", {year: currentYear});
});
